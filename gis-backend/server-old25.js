...
app.get("/api/location-proximity", async (req, res) => {
  ...
  try {
    // ========================================================
    // 1. LOAD RISK LAYER CONFIG
    //
    // HARUS SAMA DENGAN /api/location-assessment
    // menggunakan:
    //   enabled
    //   display_order
    // ========================================================

    console.log("🔍 [LOCATION PROXIMITY] Loading risk config...");
    ...
    console.log(
      `✅ [LOCATION PROXIMITY] Risk layers loaded: ${riskLayers.length}`,
    );

    // ========================================================
    // 2. CARI THREAT TERDEKAT
    // ========================================================
    ...
    const threatResults = await Promise.all(
      riskLayers.map(async (definition) => {
        try {
          ...
          /*
           * Cari feature terdekat.
           *
           * Catatan:
           * - ST_Covers dipakai supaya titik di boundary tetap dianggap
           *   berada di dalam polygon.
           * - ST_Distance geography menghasilkan meter.
           */
           ...
           * seluruh /api/location-proximity menjadi 500.
           */
    ...
    // ========================================================
    // 3. LOKASI KEGIATAN / MITIGASI TERDEKAT
    // ========================================================
    ...
    // ========================================================
    // 4. RIWAYAT KEJADIAN TERDEKAT
    //
    // Dibuat independent supaya kalau schema kejadian berbeda,
    // endpoint utama tetap hidup.
    // ========================================================
    ...
    console.error("❌ [LOCATION PROXIMITY] FATAL ERROR:", error);
