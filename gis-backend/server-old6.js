...
// WMS visual tetap di frontend; endpoint ini hanya memasok
// data titik + atribut untuk marker clickable.
// ============================================================
app.get("/api/firms/noaa21", async (req, res) => {
  ...
  try {
    ...
    const url =
      ...
      `${encodeURIComponent(firmsKey)}/?${params.toString()}`;
    ...
    console.log("🔥 FIRMS WFS BODY:", csv.slice(0, 500));
...
// Catatan:
// Endpoint /api/firms/noaa21/info sengaja tidak dipakai.
// Popup berasal dari marker yang dibuat dari data WFS di endpoint
// /api/firms/noaa21, sehingga browser tidak perlu GetFeatureInfo/CORS.
// 404 handler
app.use((req, res) => {
  res.status(404).json({
    success: false,
