...
const mainMenus: MenuItem[] = [
  ...
  /* ============================================================
     DATA KEBENCANAAN
     INPUT / REGISTRY / HISTORIS KEJADIAN
  ============================================================ */

  {
    title: "Data Kebencanaan",
    description: "Kejadian dan inventarisasi bencana",
    icon: Siren,
    children: [
      {
  ...
  /* ============================================================
     EWS - BANJIR
     EARLY WARNING SYSTEM BERBASIS HISTORIS + CURAH HUJAN
  ============================================================ */

  {
    title: "EWS – Banjir",
    description: "Early Warning System banjir",
    icon: Siren,
    children: [
      {
      ...
      },
      {
        ...
        href: "/ews/banjir/prediksi",
        icon: CloudSun,
        badge: "AI",
      },
      {
        title: "Riwayat Banjir",
        href: "/ews/banjir/riwayat",
        icon: History,
      },
    ],
  },
