              ...
              <div className="mt-6 rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1 text-left">
                    <div className="text-[10px] font-extrabold uppercase tracking-wide text-emerald-800">Akses Instansi</div>
                    <p className="mt-1 text-[10px] leading-4 text-emerald-700">Belum memiliki akun member? Ajukan akses resmi untuk instansi Anda.</p>
                    <button type="button" onClick={() => navigate("/registrasi-instansi")} className="mt-2 inline-flex h-9 items-center justify-center rounded-xl bg-white px-3 text-[10px] font-extrabold text-emerald-700 shadow-sm ring-1 ring-emerald-200 transition hover:bg-emerald-600 hover:text-white">
                      Daftar sebagai Member Instansi →
                    </button>
                  </div>
                </div>
              </div>
