          ...
          <div className="h-full flex flex-col gap-2">
            <section className="relative flex-1 min-h-0 rounded-2xl overflow-hidden bg-slate-200 shadow-sm border border-white">
              ...
              {mapWeatherPopup.open && (
                <div className="absolute right-4 top-4 z-[1900] w-[390px] max-w-[calc(100%-1.5rem)]">
                  <div className="relative overflow-hidden rounded-[22px] border border-slate-200/80 bg-white/98 shadow-[0_24px_70px_rgba(15,23,42,0.24)] backdrop-blur-sm">
                    <div className="absolute -left-3 top-[104px] h-6 w-6 rotate-45 border-b border-l border-slate-200/80 bg-white" />

                    {/* Header */}
                    <div className="relative border-b border-slate-100 px-5 pt-4 pb-3">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 pr-2">
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-blue-600">
                              OPEN-METEO • CUACA WILAYAH
                            </div>
                          </div>
                          <div className="mt-1.5 truncate text-[23px] leading-tight font-black tracking-tight text-slate-900">
                        ...
                        <button
                          ...
                          className="shrink-0 flex h-7 w-7 items-center justify-center rounded-full text-lg leading-none text-slate-400 transition hover:bg-slate-100 hover:text-slate-700"
                    ...
                    {/* Scrollable content: popup stays fully inside the map */}
                    <div className="max-h-[calc(100vh-150px)] overflow-y-auto px-5 pb-4 dashboard-scroll">
                        ...
                        <div className="pt-4">
                          ...
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex min-w-0 items-center gap-3">
                              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-sky-50 text-3xl ring-1 ring-sky-100">
                                {weatherIcon(mapWeatherPopup.current.weather_code)}
                              </div>
                              <div className="min-w-0">
                                <div className="text-[34px] leading-none font-black tracking-tight text-slate-900">
                                  {mapWeatherPopup.current.temperature_2m ?? "—"}°C
                                </div>
                                <div className="mt-1 truncate text-[13px] font-bold text-blue-600">
                            ...
                            <div className="shrink-0 rounded-xl bg-slate-50 px-3 py-2 text-right">
                              <div className="text-[9px] uppercase tracking-wider text-slate-400">Kondisi</div>
                              <div className="mt-0.5 text-[11px] font-bold text-slate-700">Saat ini</div>
                            </div>
                          </div>

                          {/* Rain hero card */}
                          <div className="mt-4 rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-sky-50 p-4">
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                <div className="text-[10px] font-extrabold uppercase tracking-[0.12em] text-blue-700">
                                  Curah Hujan Hari Ini
                                </div>
                                <div className="mt-1 flex items-end gap-1">
                                  <span className="text-[31px] leading-none font-black text-blue-700">
                                    {mapWeatherPopup.dailyRain ?? "—"}
                                  </span>
                                  <span className="mb-0.5 text-[12px] font-bold text-blue-600">mm</span>
                                </div>
                              </div>
                              <div className="rounded-xl bg-white/80 px-2.5 py-2 text-right ring-1 ring-blue-100">
                                <div className="text-[9px] text-slate-400">Saat ini</div>
                                <div className="text-[12px] font-extrabold text-slate-700">
                                  {mapWeatherPopup.current.precipitation ?? "—"} mm
                                </div>
                              </div>
                            </div>
                          </div>

                          {/* Weather metrics - 2 columns prevents vertical clipping */}
                          <div className="mt-3 grid grid-cols-2 gap-2">
                            {[
                              ...
                              <div key={label} className="min-w-0 rounded-xl border border-slate-100 bg-slate-50/80 px-3 py-2.5">
                                <div className="flex items-center gap-2 text-[10px] text-slate-500">
                                  <span className="w-4 shrink-0 text-center text-sm">{icon}</span>
                                  <span className="truncate">{label}</span>
                                </div>
                                <div className="mt-1 pl-6 text-[13px] font-extrabold text-slate-800">{value}</div>
                              </div>
                            ))}
                          </div>

                          {/* Source / timestamp */}
                          <div className="mt-3 flex items-center justify-between gap-3 border-t border-slate-100 pt-3 text-[9px] text-slate-400">
                            <div className="min-w-0 truncate">
                              Diperbarui: {formatWeatherTime(mapWeatherPopup.updatedAt)}
                            </div>
                            <div className="shrink-0 font-bold text-blue-600">Sumber: Open-Meteo</div>
                          </div>
                        </div>
                      ) : null}
                    </div>
