...
const Kerawanan = () => {
  ...
  const buildHotspotPopup = (hotspot: FirmsHotspot) => {
    ...
    const frp =
      hotspot.frp !== undefined && hotspot.frp !== null && hotspot.frp !== ""
        ? `${Number(hotspot.frp).toFixed(2)} MW`
        : "-";

    const acquisition = formatWibTime(hotspot.acq_date, hotspot.acq_time);
    ...
    ">
      ...
      <div style="border-top:1px solid #e5e7eb;padding-top:8px;">
        ...
        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Satelit</div>
          <div style="font-weight:700;">
            ${escapeHtml(value(hotspot.satellite, "NOAA-21"))}
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Instrumen</div>
          <div style="font-weight:700;">
            ${escapeHtml(value(hotspot.instrument, "VIIRS"))}
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Produk</div>
          <div style="font-weight:700;">
            VIIRS_NOAA21_NRT
          </div>
        </div>
        ...
        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">FRP</div>
        ...
        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Confidence</div>
          <div style="font-weight:700;">
            ${escapeHtml(value(hotspot.confidence))}
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Acquisition</div>
          <div style="font-weight:700;">
            ${escapeHtml(acquisition)} WIB
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Latitude</div>
          <div style="font-weight:700;">
            ${Number(hotspot.latitude).toFixed(6)}
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Longitude</div>
          <div style="font-weight:700;">
            ${Number(hotspot.longitude).toFixed(6)}
          </div>
        </div>

        <div style="display:flex;margin-bottom:6px;">
          <div style="width:105px;color:#6b7280;">Day/Night</div>
          <div style="font-weight:700;">
            ${escapeHtml(value(hotspot.daynight))}
          </div>
        </div>

        <div style="display:flex;">
          <div style="width:105px;color:#6b7280;">Scan / Track</div>
          <div style="font-weight:700;">
            ${escapeHtml(value(hotspot.scan))} /
            ${escapeHtml(value(hotspot.track))}
          </div>
        </div>
