...
const Kerawanan = () => {
  ...
  const FIRMS_AREA_BBOX = "-11,95,6,141";
  ...
  const fetchSatelliteHotspots = async () => {
    if (!FIRMS_MAP_KEY) {
      setSatelliteHotspots((prev) => ({
        ...prev,
        loading: false,
        error: "VITE_FIRMS_MAP_KEY belum dikonfigurasi.",
      }));
      return;
    }
    ...
    try {
      ...
      try {
        hotspots = await fetchSatelliteHotspotsFromWfs();
      } catch (wfsError) {
        console.warn(
          "NASA FIRMS WFS gagal, mencoba Area CSV sebagai fallback:",
          wfsError,
        );
        hotspots = await fetchSatelliteHotspotsFromCsv();
      }
      ...
      console.error("NASA FIRMS hotspot fetch error:", error);
              ...
              <div className="absolute top-3 left-3 right-3 z-[1200] flex items-center gap-2 pointer-events-none">
                <div className="ml-auto pointer-events-auto flex items-center gap-2">
                  ...
                  <div className="bg-white/95 backdrop-blur rounded-xl shadow-lg px-3 py-2 min-w-[190px]">
                    ...
                    {!satelliteHotspots.error && satelliteHotspots.updatedAt && (
